...
public class ColtsStaffDirectory extends JPanel {
    ...
    public ColtsStaffDirectory(Runnable onBack) {
        this.onBack = onBack;
        // Original, these are Jframe-only methods, don't exist on Jpanel:
    ...
    private void returnToMainMenu() {
        // Original, dispose() is Jframe-only; "new MainMenu()" pointed at the embedded placeholder class below, not the real one:
        // dispose();
    ...
    //    }
    //}
    // ORIGINAL — redundant entry point, now resolves to the real MainMenu.java by accident since the placeholder above is commented out. Not needed here:
